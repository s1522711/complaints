...
A self-hosted complaints form with email forwarding and an admin panel. Built with Node.js, Express, and plain HTML/CSS/JS. No database binary required — complaints are stored in a local JSON file.
...
- **Admin panel** — view, filter, search, update status, and delete complaints
...
- Click any row's view button to see the full complaint in a modal
